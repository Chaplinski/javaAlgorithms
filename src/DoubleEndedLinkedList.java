public class DoubleEndedLinkedList {
    ...
    public static void main(String[] args){
        ...
        theLinkedList.insertInOrder("Scott Chaplinski", 72);
        theLinkedList.insertInOrder("Pierce Hawthorne", 68);
        theLinkedList.insertInOrder("Rumplestiltskin", 9);
        theLinkedList.insertInOrder("Petunia Dersley", 14);

        theLinkedList.insertAfterKey("Joeey Shabadoo", 19, 9);
